...
CREATE TABLE Maintenance (
    ...
    status NVARCHAR(20) CHECK (status IN ('Đang bảo trì', 'Hoàn thành')) DEFAULT 'Đang bảo trì',
    note NVARCHAR(255),
    FOREIGN KEY (vehicle_id) REFERENCES Vehicles(vehicle_id),
    FOREIGN KEY (user_id) REFERENCES Users(id)
);
...
('admin01', 'admin@123', 'Nguyễn Văn A', 'Admin', 'admin01@example.com', '0912345678'),
('nv_kho01', 'nv123456', 'Trần Văn B', 'NhanVien', 'nv_kho01@example.com', '0987654321'),
('nv_kho02', 'nv654321', 'Lê Thị C', 'NhanVien', 'nv_kho02@example.com', '0978123456');
...
('Suzuki Raider', 'Suzuki', 'RA150', 'Đỏ', 'GHI789123', 'OPQ456789', 2023, 'Trong kho');
INSERT INTO Suppliers (name, address, phone, email) VALUES
('Công ty Honda Việt Nam', 'Hà Nội, Việt Nam', '0241234567', 'honda_vn@example.com'),
('Công ty Yamaha Motor', 'TP. Hồ Chí Minh, Việt Nam', '0289876543', 'yamaha_vn@example.com'),
('Công ty Suzuki Việt Nam', 'Đồng Nai, Việt Nam', '0251678902', 'suzuki_vn@example.com');
INSERT INTO Import_Stock (supplier_id, user_id, import_date, note) VALUES
(1, 1, '2024-03-01 10:00:00', 'Nhập lô hàng đầu tháng 3'),
(2, 2, '2024-03-02 14:30:00', 'Nhập xe Yamaha Exciter'),
(3, 3, '2024-03-03 16:00:00', 'Nhập xe Suzuki Raider');
...
(1, '2024-03-05 09:00:00', 'Chuyển xe đến cửa hàng số 1', 'Cửa hàng 1'),
(2, '2024-03-06 11:30:00', 'Xuất xe cho khách đặt hàng', 'Nguyễn Văn D'),
(3, '2024-03-07 15:00:00', 'Chuyển xe đến chi nhánh mới', 'Chi nhánh 2');
...
(1, 2, '2024-03-10 08:00:00', NULL, 'Đang bảo trì', 'Xe bị lỗi phanh'),
(2, 3, '2024-03-12 10:00:00', '2024-03-15 17:00:00', 'Hoàn thành', 'Bảo trì định kỳ'),
(3, 2, '2024-03-14 14:00:00', NULL, 'Đang bảo trì', 'Lỗi động cơ');
